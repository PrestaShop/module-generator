...
function (e) {
	...
	return n.View.extend({
		...
		getBottomAbove: function (n) {
			var r = e(this.$el.find(".component")),
				i = t.find(r, function (t) {
					// FIX: Collision between element and mouse
					var div = e(t),
					divTop = div.offset().top,
					divBottom = divTop + div.height();
					return divBottom > n - 90 ? !0 : !1
				});
			return i ? i : r[0]
		},
		...
		handleTempMove: function (t) {
			...
			mouseX = t.pageX;
			mouseY = t.pageY;
			e(".target").removeClass("target"), mouseX >= divLeft && mouseX <= divRight && mouseY >= divTop && mouseY <= divBottom ? e(this.getBottomAbove(mouseY)).addClass("target") : e(".target").removeClass("target")
		},
	...
	baseUrl: "../modules/modulegenerator/js/lib/",
	shim: {
		backbone: {
