...
<div id="step-1">
	<form id="validFirstStep">
		<div class="center-block alert alert-block alert-danger hide">
			...
			<h4><i class="icon-times"></i>{l s='Oh snap! You got an error!' mod='modulegenerator'}</h4>
			<p>{l s='You must fill in all fields marked with a * to continue to the next step' mod='modulegenerator'}</p>
		</div>
		<!-- Name -->
